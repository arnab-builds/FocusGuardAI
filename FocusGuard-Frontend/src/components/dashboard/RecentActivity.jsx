...
export default function RecentActivity({ activities }) {
  ...
  return (
    <section className="flex min-h-[420px] flex-col overflow-hidden rounded-2xl border border-indigo-100/50 dark:border-slate-700 bg-blue-50/30 dark:bg-slate-800 p-5 shadow-sm transition-all duration-200 hover:shadow-md hover:-translate-y-[2px]">
      {/* Header */}
          ...
          recentItems.map((activity) => (
            ...
            >
              ...
              <div className="shrink-0 text-left sm:text-right">
                <p className="rounded-lg bg-indigo-50/50 dark:bg-indigo-900/30 px-3 py-1.5 text-sm font-semibold text-indigo-700 dark:text-indigo-300 shadow-sm ring-1 ring-inset ring-indigo-100 dark:ring-indigo-800">
                  {activity.duration
                    ? formatDuration(
                        activity.duration,
                        t,
