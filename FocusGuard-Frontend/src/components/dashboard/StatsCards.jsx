  ...
  const cards = [
    {
      ...
      badgeColor: "bg-emerald-100/60 text-emerald-700 dark:bg-emerald-900/50 dark:text-emerald-300",
    ...
    },
    {
      ...
      badgeColor: "bg-rose-100/60 text-rose-700 dark:bg-rose-900/50 dark:text-rose-300",
    ...
    },
    {
      ...
      badgeColor: "bg-amber-100/60 text-amber-700 dark:bg-amber-900/50 dark:text-amber-300",
    ...
    },
    {
      ...
      badgeColor: "bg-cyan-100/60 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300",
    ...
    },
    {
      ...
      badgeColor: "bg-indigo-100/60 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300",
    ...
    <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-5">
      {cards.map((card) => {
        ...
        return (
          <div
            key={card.title}
            className={`flex min-h-[170px] flex-col justify-between rounded-2xl border border-slate-200 dark:border-slate-700/50 p-5 shadow-sm transition-all duration-200 hover:-translate-y-[2px] hover:shadow-md border-t-[3px] ${card.border} ${card.cardTint}`}
          >
            <div className="flex items-start justify-between gap-4">
              <div className="min-w-0 flex-1">
                <p className="truncate text-xs font-semibold uppercase tracking-wider text-slate-600 dark:text-slate-400">
                  {card.title}
                </p>
