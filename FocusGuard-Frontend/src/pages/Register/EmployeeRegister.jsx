...
function EmployeeRegister() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-500 px-4 py-10 sm:px-6 lg:px-8">
