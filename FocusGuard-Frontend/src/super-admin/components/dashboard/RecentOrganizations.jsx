...
function RecentOrganizations({
    ...
    return (
        <div className="rounded-3xl shadow-sm hover:shadow-md border border-blue-100/50 bg-gradient-to-br from-blue-50/70 to-white p-5 sm:p-6 lg:p-7 transition-all duration-300">
